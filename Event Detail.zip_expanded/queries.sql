...
create table event(id number(19) primary key,event_name varchar2(255),organiser varchar2(255),organiser_number varchar2(255),hall_name varchar2(255),location varchar2(255));
